...
!function (e, t) {
...
}(jQuery, document), function (e, t, n, i, o) {
    function a(e, t, n) {
        function i() {
            var e = .5 * t;
            a(s, e, .5), a(c, e, .5), n || a(h, e + .25, .3)
        }

        function a(e, t, n, i, a) {
            e.css("transform", i || "scale(0)"), o.to(e.get(0), n || .5, {transform: a || "scale(1)", delay: t})
        }

        function r() {
            o.to(e.get(0), .3, {
                transform: "scale(0)", onComplete: function () {
                    e.trigger(p)
                }
            })
        }
        ...
        var s = e.find(".earth-popup__preview-hexagon"), c = e.find(".earth-popup__item-shadow"),
    ...
    function r(e, t, n) {
        function a() {
            i(".toogle-map-mobile").stop().fadeOut(300), o.to(e.get(0), .5, {transform: "translate(0, 0)"})
        }

        function r() {
            i(".toogle-map-mobile").stop().fadeIn(300), o.to(e.get(0), .3, {
    ...
    var s, c, l = "show", d = "hide", u = "item:select", p = "item:remove";
    i.fn.earthPopupItem = function (e, t) {
        return this.each(function (n, o) {
            var r = i(this), s = r.data("earthPopupItem");
            s || r.data("earthPopupItem", s = new a(r, n, t)), s.init(e)
        })
    }, i.fn.earthMobileTip = function (e, t) {
        return console.log(e), this.each(function (n, o) {
            itm = new r(i(this), n, t), itm.init(e)
        })
    }, e.getHexaspherePopup = function (e, n, o) {
        var a, r, h;
        return s || (c = i("#earth-popup[type='text/x-handlebars-template']"), s = t.compile(c.html())), a = i(s(e)).appendTo(c.parent()), a.localization("en"), o && (scriptMobile = i("#earth-mobile-tip[type='text/x-handlebars-template']"), templateMobile = t.compile(scriptMobile.html()), collectionMobile = i(templateMobile(e)).appendTo(scriptMobile.parent()), h = collectionMobile.on(u, function (t, i) {
            n(e[i])
        }).on(p, function (e) {
            i(e.target).remove()
        }).earthMobileTip(l)), r = a.find(".earth-popup__item").on(p, function () {
            a.remove(), a = void 0, r = void 0
        }).earthPopupItem(l, !!o), o || r.on(u, function (t, i) {
            n(e[i])
        }), {
            element: a.get(0), action: function (e) {
                a && a.toggleClass("earth-popup_moving", !0 === e || "mousedown" === e)
            }, close: function () {
                r && r.earthPopupItem(d), h && h.earthMobileTip(d), r = void 0, h = void 0
            }
        }
    }
...
}(document, window), function (e, t, n, i, o) {
    function a(e) {
        function n(n) {
    ...
    function c(e, t, i, a, r) {
        ...
        return p = langUrl + "api/" + (w.hasOwnProperty(e) ? w[e] + "?" + Date.now() : "" + "?" + Date.now()), function (n, r, l) {
            function u(e, t) {
                ...
                ;var ptype = getCookie3("selectedYear") == null ? window.myProTypes[1] : getCookie3("selectedYear");
                ...
                if (ajaxUrl === "locations") {
                    ...
                    if (window.myProTypes.indexOf(parseInt(ptype)) == 0) {
                        parseShowData(ptype, window.metaLocationData1)
                    }
                    ;
                    if (window.myProTypes.indexOf(parseInt(ptype)) == 1) {
                        parseShowData(ptype, window.metaLocationData2)
                    }
                    ;
                    if (window.myProTypes.indexOf(parseInt(ptype)) == 2) {
                        parseShowData(ptype, window.metaLocationData3)
                    }
                    ;
...
function parseShowData(yname, e) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        yearsData[yname] = {
            ...
            "works_list": [{"name": data[i].planName, "link": data[i].link}]
        };
        ...
        var slocation = {};
        slocation["location"] = {"city": data[i].name, "country": "China"};
        slocation[yname] = {url: "", briefs: [{id: data[i].link, name: data[i].planName, year: yname, type: "thing"}]};
        locationsFData[id] = slocation
    }
}
